...
#SBATCH --array=0-29%4
#SBATCH --output=/share/home/rongdingyi/programs/proteingen/VHHdata/audit_logs/paper-abck-%A_%a.out
#SBATCH --error=/share/home/rongdingyi/programs/proteingen/VHHdata/audit_logs/paper-abck-%A_%a.err
set -euo pipefail
...
RUNS=(diff_only drop_only gain_only)
run=${RUNS[$((i % 3))]}
