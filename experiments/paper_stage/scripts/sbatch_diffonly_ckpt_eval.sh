#!/usr/bin/env bash
#SBATCH --job-name=paper-diffonly-cksel
...
#SBATCH --array=0-19%4
#SBATCH --output=/share/home/rongdingyi/programs/proteingen/VHHdata/audit_logs/paper-diffonly-cksel-%A_%a.out
#SBATCH --error=/share/home/rongdingyi/programs/proteingen/VHHdata/audit_logs/paper-diffonly-cksel-%A_%a.err
set -euo pipefail
...
RUNS=(diff_only_s43 diff_only_s44)
run=${RUNS[$((i % 2))]}
