...
#SBATCH --mem=64G
#SBATCH --time=8:00:00
#SBATCH --output=/share/home/rongdingyi/programs/proteingen/VHHdata/audit_logs/slcf-gpu-%A.out
#SBATCH --error=/share/home/rongdingyi/programs/proteingen/VHHdata/audit_logs/slcf-gpu-%A.err
set -euo pipefail
